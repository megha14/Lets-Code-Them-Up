/**  
* GraphAdjacencyListWeightedDirected --- Program to represent WEIGHTED DIRECTED graph as Adjacency List
...
public class GraphAdjacencyListWeightedDirected{
	...
	//Default Constructor 
	public GraphAdjacencyListWeightedDirected(){
	}
    ...
    */ 
	public static void main(String args[]){
		...
		GraphAdjacencyListWeightedDirected graph = new GraphAdjacencyListWeightedDirected();
